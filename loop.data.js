...
const DIMENSIONS = [
  { id:'confidence', color:'#7c5cfc', tint:'#f0ecff', ico:'🛡️', facets:['Trying hard things','Recovering from mistakes','Self-belief','Academic risk-taking'],   name:'Confidence',   emoji:'💪',
  ...
  { id:'curiosity', color:'#eab308', tint:'#fef6dc', ico:'💡', facets:['Asking questions','Exploring ideas','Creativity','Wanting to know why'],    name:'Curiosity',    emoji:'🔎',
  ...
  { id:'connection', color:'#ec4899', tint:'#fdeaf4', ico:'👥', facets:['Friendships','Communication','Empathy','Belonging'],   name:'Connection',   emoji:'🤝',
  ...
  { id:'independence', color:'#f97316', tint:'#feeee0', ico:'🧭', facets:['Homework habits','Organization','Responsibility','Problem-solving'], name:'Independence', emoji:'🧭',
  ...
  { id:'resilience', color:'#14b8a6', tint:'#e2f7f4', ico:'🌱', facets:['Handling disappointment','Emotional regulation','Persistence','Flexibility'],   name:'Resilience',   emoji:'🌱',
  ...
  { id:'learning', color:'#2563eb', tint:'#e6edfe', ico:'📘', facets:['Reading','Math','Writing','Executive functioning','Study skills'],     name:'Learning',     emoji:'📚',
...
/* Always work, no data required. Kept deliberately good rather than cute. */
const STARTERS_ALWAYS = [
  { q:`What was the funniest thing that happened today?`,
    why:`"How was school?" asks for a verdict. This asks for a story — and stories are where the actual information is.`,
    follow:`Who else thought it was funny?` },
  { q:`Who did you sit with at lunch?`,
    why:'The most reliable social question there is, because it has one factual answer and no judgment in it.',
    follow:`Is that who you usually sit with?` },
  { q:`What was the hardest part of today?`,
    why:'Gives permission for the day to have been hard, which is the thing "fine" is usually covering.',
    follow:`What made it easier — or did it not get easier?` },
  { q:`Tell me one thing that made you go "huh".`,
  ...
  { q:`If you were the teacher tomorrow, what would you change?`,
  ...
  { q:`What's something you helped someone with today?`,
  ...
  { q:`Rate today out of ten — and tell me what the missing points were.`,
  ...
  { q:`What do you know now that you didn't know this morning?`,
    why:'Reframes learning as something that happened to them today, not something they were tested on.',
